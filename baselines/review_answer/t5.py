...
def T5Trainer(
    ...
    for epoch in range(model_params["VAL_EPOCHS"]):
        ...
        bert_results = bertscore.compute(predictions=predictions, references=actuals, model_type="distilbert-base-uncased")
        b = b_results["bleu"]
        r = r_results['rougeL']
        ...
        logging.info(f'Validation ROUGE score {bscore}')
...
def T5Tester(text_address, model_params, country, market_type, output_dir="./outputs/"):
    ...
    logging.info(f'TEST Bert score {bscore}')
...
if args.gpt4:
    ...
    if model_params['MODEL'].find('mt5')<0:
        ...
        output_dir = "mt5_outputs_"+c+"_"+market_type
if args.gpt4:
